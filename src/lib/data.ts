...
export const menuItems = [
  ...
  },
  {
    ...
    name: "Supreme Pizza",
    description:
      "Pizza with pepperoni, sausage, bell peppers, onions, and olives",
    price: 16.99,
    imageUrl: "/placeholder.svg?height=300&width=400",
  },
  {
  ...
  },
  {
    ...
    name: "Veggie Burrito",
    description:
      "Large flour tortilla with beans, rice, veggies, and guacamole",
    price: 10.99,
    imageUrl: "/placeholder.svg?height=300&width=400",
  },
  {
    ...
    name: "Nachos Supreme",
    description:
      "Tortilla chips topped with beans, cheese, jalapeños, and sour cream",
    price: 7.99,
    imageUrl: "/placeholder.svg?height=300&width=400",
  },
