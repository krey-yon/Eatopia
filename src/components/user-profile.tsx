...
const UserProfile = ({user} : {user : User | null}) => {
    return user ? <div>
                ...
                <div className={"p-4 flex items-center space-x-4"}>
                    ...
                    <div className={"flex flex-col space-y-1"}>
                        ...
                        <button onClick={async () => {
                            await logoutActions()
                        }} className={"mt-4 border-2 rounded-xl flex items-center justify-center space-x-1 border-[#ededed] text-[#8d8d8d] hover:bg-gray-200 transition duration-150"}>
        ...
        <button className='bg-orange-600 text-white rounded-md py-1 px-2 hover:bg-orange-700'>Log In</button>
